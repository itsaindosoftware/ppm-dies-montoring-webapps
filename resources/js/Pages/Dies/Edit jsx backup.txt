                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g., 800T, 1200T, Progressive"
                                        className="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm"
                                    />
                                ...
                                <div>
                                    ...
                                    <select
                                        value={data.dies_size}
                                        onChange={(e) => setData('dies_size', e.target.value)}
                                        className="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm"
                                    >
                                        <option value="">-- Select Line --</option>
                                        <option value="A1 Line">A1 Line</option>
                                        <option value="A2 Line">A2 Line</option>
                                        <option value="B1 Line">B1 Line</option>
                                        <option value="B2 Line">B2 Line</option>
                                    </select>
                                    {errors.dies_size && <p className="text-red-500 text-xs mt-1">{errors.dies_size}</p>}
                                    <p className="text-xs text-gray-500 mt-1">
                                        Production line location (A1, A2, B1, B2)
                                    </p>
                                </div>
                            </div>
